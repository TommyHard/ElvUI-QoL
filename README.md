...
* **Melee Range Tracking:**
  ...
  * Accurately calculates distance based on your class's core melee abilities (*includes specialized support for Holy Paladins using item-based distance checks*).
...
* **Seamless Integration:** Safely hooks into ElvUI's core functions, applying your settings to all tracked auras without conflicting with the base user interface.
...
| **Interface Version** | `120000` / `120001` / `120005` (Midnight Compatible) |
